  ...
  const onSubmit = () => {
    if (dataContent.length === 0) {
      ...
      updateAdCampaign(data)
        ...
        .catch((e) => toast.error('Sửa thất bại'))
        .then(() => {
          setTimeout(() => {
    ...
    <div className="container-fluid">
      ...
      <div className=" container">
        ...
        <div className="item">
          ...
          >
            <FormControlLabel
              control={<Checkbox value={'SMS'} onChange={(e) => onClickCheckMethod(e)} />}
              label="SMS"
            />
            <FormControlLabel
              control={<Checkbox value={'Zalo'} onChange={(e) => onClickCheckMethod(e)} />}
              label="Zalo"
            />
            <FormControlLabel
              control={<Checkbox value={'Email'} onChange={(e) => onClickCheckMethod(e)} />}
              label="Email"
            />
          </FormGroup>
        </div>
        ...
        <div className="popup-listGroups">
          <Dialog open={open} onClose={handleClose}>
            <div className="test ">
              ...
              <div>
                <Stack direction="row" spacing={2}>
                  <Button variant="contained" onClick={onSubmitSearchNameGroup}>
                    Tìm Nhóm
                  </Button>
                </Stack>
              </div>
