export default {
  ...
  'pages.login.wrongusername': 'ログインに失敗しました。再試行してください！',
  'pages.login.wrongpassword': 'ログインに失敗しました。再試行してください！',
  'pages.login.success': 'ログイン成功！',
  'systemalert.login.wrongusername': 'ログインに失敗しました。再試行してください！',
  'systemalert.login.wrongpassword': 'ログインに失敗しました。再試行してください！',
  'systemalert.login.success': 'ログイン成功！',
  'pages.login': 'ログイン',
  ...
  'pages.modules.reception': 'レセプション',
  'pages.modules.reservation': '予約',
  'pages.modules.housekeeping': 'ハウスキーピング',
  'pages.modules.setting': '家',
  'pages.modules.manage': '管理',
  'pages.modules.dashboard': 'ダッシュボード',
  'pages.modules.changepass': 'パスワードを変更する',
  'pages.modules.logout': 'ログアウト',
  'pages.changepass.newpass': '新しいパス',
  'pages.changepass.oldpass': '以前のパスワード',
  'pages.changepass.confirmpass': 'パスワードを認証する',
  'pages.changepass.oldpass': '以前のパスワード',
  'pages.changepass.button': 'パスワードを変更する',
  'pages.changepass.cancel': 'キャンセル',
  'pages.changepass.title': 'パスワードを変更する'
};
